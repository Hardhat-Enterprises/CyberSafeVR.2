...
public class TutorialManager : MonoBehaviour
{
    ...
    {        
        ...
        {
            new TutorialStep(
                "Hello and welcome to virtual reality! When you're ready, take a look at the painting behind your shoulder on your right",
            ...
            new TutorialStep(
                "And now the painting behind on your left?",
            ...
            new TutorialStep(
                "Next, put your controllers out in front of you inside these spheres",
                () => ControllersInFront(),
                0.5f,
                () => {
            ...
            new TutorialStep(
                "Lets go through what the buttons on the controllers do for you",
                () => true,
                3.5f,
                null,
                null
            ...
            new TutorialStep(
                "This is the 'trigger button' try pressing each one on your controllers. I've highlighted them in blue on these example controllers.",
            ...
            new TutorialStep(
                "You're a natural. Next I've highlighted the 'grip button' in blue. This is used to pick things up. Try picking up this basketball",
                () => PickedUpBasketball(),
                0f,
                () => 
                {
