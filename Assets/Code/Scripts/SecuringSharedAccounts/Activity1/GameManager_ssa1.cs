...
public class GameManager_SSA1 : MonoBehaviour
{
    public TeleportManager_SSA01 teleportManager; // Reference to the TeleportManager
    ...
    void Start()
    {
        ...
        {
            teleportManager = Object.FindFirstObjectByType<TeleportManager_SSA01>();
        }
    }
